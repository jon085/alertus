...
*/
$seven_bit_msg = "User pressed the panic button. Emergency response inbound. GPS location S58,8,2:E,23,2,1";
...
*/
$unicode_msg = "GPS location S58,8,2:E,23,2,1";
...
*/
//$eight_bit_msg = '6a6f6e747920697320617765736f6d65';
...
function SendSMS($SMSReceiver, $SMSBody)
{
    echo "UN: " . $GLOBALS['username'] . "<br>";
    echo "UN: " . $GLOBALS['password'] . "<br>";
    echo "UN: " . $SMSBody . "<br>";
    
    $post_body = seven_bit_sms( $GLOBALS['username'], $GLOBALS['password'], $SMSBody, $SMSReceiver );
        
    $result = send_message( $post_body, $GLOBALS['url'], $GLOBALS['port'] );
    if( $result['success'] ) {
